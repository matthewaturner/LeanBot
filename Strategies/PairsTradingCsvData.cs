 ...
 * 
 * Implements a mean-reverting pairs trading strategy between GLD (SPDR Gold Shares ETF) 
 * and GDX (VanEck Gold Miners ETF) using custom CSV data files.
 * 
 * Strategy Overview:
 ...
 * 
 * This version uses QuantConnect's custom data API to load CSV files and places
 * actual orders through the QuantConnect trading engine.
 */
...
/// <summary>
/// Custom data class for loading CSV price data through QuantConnect's data pipeline
/// </summary>
    ...
    public override BaseData Reader(SubscriptionDataConfig config, string line, DateTime date, bool isLiveMode)
    {
        ...
        try
        {
            ...
            var data = new CustomCsvData
            {
                ...
                Value = Convert.ToDecimal(csv[6].Trim(), CultureInfo.InvariantCulture) // Adj Close as Value
            };
...
/// <summary>
/// Mean-reverting pairs trading strategy for GLD and GDX using CSV data
/// </summary>
public class PairsTradingCsvData : QCAlgorithm
{
    ...
    {
        // Set backtest period to match CSV data range
        // GLD data: 11/18/2004 to 11/30/2007
        // GDX data: 5/23/2006 to 11/30/2007
        // Common range: 5/23/2006 to 11/30/2007
        ...
        // Add custom CSV data for GLD and GDX
        ...
        Debug("=== Pairs Trading Algorithm: GLD vs GDX (CSV Data) ===");
    ...
    /// <summary>
    /// OnData event - main trading logic executed on each data point
    /// </summary>
    public override void OnData(Slice data)
    {
        ...
        // Use adjusted close price (stored in Value)
        decimal gldPrice = gldData.Value;
        decimal gdxPrice = gdxData.Value;
